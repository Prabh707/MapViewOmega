...
import { TransitStop, TransitLine, ReportType, ReportCategory, ReportSeverity, CommunityReport } from '../types/transit';
...
export const ReportModal: React.FC<ReportModalProps> = ({
  ...
  const REPORT_TYPE_CONFIGS: Record<ReportType, {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fadeIn" role="dialog" aria-modal="true" aria-labelledby="reportModalHeading">
      <div className="bg-slate-900 border border-slate-700/80 rounded-2xl w-full max-w-2xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-slate-800 flex items-center justify-between bg-slate-950/80">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 id="reportModalHeading" className="text-lg font-black text-white">Report Transit Barrier or Condition</h2>
              <p className="text-xs text-slate-400">Instantly alerts operators and updates community safety routing</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto custom-scrollbar flex-1">
              ...
              {(Object.keys(REPORT_TYPE_CONFIGS) as ReportType[]).map((typeKey) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[11px] text-slate-400 font-medium line-clamp-2">
                      {conf.title}
                    </span>
                  </button>
                );
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label htmlFor="reportStopSelect" className="block text-xs font-bold uppercase tracking-wider text-slate-300 mb-1.5">
            ...
            <div>
              <label htmlFor="reportLineSelect" className="block text-xs font-bold uppercase tracking-wider text-slate-300 mb-1.5">
          ...
          {reportType === 'delay' && (
            <div className="p-4 rounded-xl bg-amber-950/40 border border-amber-800/60 space-y-2">
              <label htmlFor="delayMinutesRange" className="block text-xs font-bold uppercase text-amber-300">
                Estimated Transit Delay: <span className="text-white font-black">+{delayMinutes} Minutes</span>
              </label>
              <input
          ...
          <div>
            <label htmlFor="reportDetailsInput" className="block text-xs font-bold uppercase tracking-wider text-slate-300 mb-1.5">
