    ...
    >
      ...
      <div className="flex items-start justify-between gap-2 mb-3">
        ...
        <div className="flex flex-col items-end">
          <div
            className={`px-2.5 py-1 rounded-xl text-xs font-extrabold flex items-center space-x-1 ${
      ...
      <div className="grid grid-cols-4 gap-2 py-2.5 px-3 rounded-xl bg-slate-950/80 border border-slate-800/80 mb-3 text-center">
        ...
        <div>
          ...
          <span
            className={`text-sm font-black ${route.totalWalkDistanceMeters > preferences.maxWalkDistanceMeters ? 'text-amber-400' : 'text-emerald-400'}`}
          >
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition ${
              isSelected ? 'bg-emerald-600 text-white' : 'bg-slate-800 hover:bg-slate-700 text-slate-200'
            }`}
          >
