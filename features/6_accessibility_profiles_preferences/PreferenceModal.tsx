...
export const PreferenceModal: React.FC<PreferenceModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-fadeIn" role="dialog" aria-modal="true" aria-labelledby="prefModalTitle">
      <div className="bg-slate-900 border border-slate-700/80 rounded-2xl w-full max-w-2xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-slate-800 flex items-center justify-between bg-slate-950/60">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 id="prefModalTitle" className="text-lg font-bold text-white">Accessibility & Travel Preferences</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <label className="flex items-start space-x-3 p-3 rounded-xl bg-slate-800/40 border border-slate-700/60 cursor-pointer hover:bg-slate-800/70 transition">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">Strictly filters out non-accessible stops & vehicles without ramps</p>
                </div>
              </label>
              ...
              <label className="flex items-start space-x-3 p-3 rounded-xl bg-slate-800/40 border border-slate-700/60 cursor-pointer hover:bg-slate-800/70 transition">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">Bypasses stations with stair-only concourses or broken escalators</p>
                </div>
              </label>
              ...
              <label className="flex items-start space-x-3 p-3 rounded-xl bg-slate-800/40 border border-slate-700/60 cursor-pointer hover:bg-slate-800/70 transition">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">Prioritizes high-intensity LED lighting, CCTV, & Blue-Light SOS stations</p>
                </div>
              </label>
              ...
              <label className="flex items-start space-x-3 p-3 rounded-xl bg-slate-800/40 border border-slate-700/60 cursor-pointer hover:bg-slate-800/70 transition">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">Favors low passenger density shuttles with open wheelchair bays</p>
                </div>
              </label>
              ...
              <label className="flex items-start space-x-3 p-3 rounded-xl bg-slate-800/40 border border-slate-700/60 cursor-pointer hover:bg-slate-800/70 transition">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">Bypasses stations with reported out-of-service elevators</p>
                </div>
              </label>
              ...
              <label className="flex items-start space-x-3 p-3 rounded-xl bg-slate-800/40 border border-slate-700/60 cursor-pointer hover:bg-slate-800/70 transition">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">Announces route changes, curb cues, and boarding step-free warnings</p>
                </div>
              </label>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-xs font-bold text-emerald-400 bg-emerald-950 px-2 py-0.5 rounded border border-emerald-800">
                {localPrefs.maxWalkDistanceMeters} meters (~{Math.round(localPrefs.maxWalkDistanceMeters / 80)} min walk)
              </span>
            </div>
            ...
            <div className="grid grid-cols-4 gap-2">
              {[150, 300, 600, 1000].map((dist) => (
                ...
                >
                  &lt; {dist}m {dist <= 150 ? '(Minimal)' : dist === 300 ? '(Low)' : dist === 600 ? '(Moderate)' : '(Standard)'}
                </button>
              ))}
            </div>
          </div>
            ...
            <div className="space-y-2 text-xs">
              ...
              <div>
                <div className="flex justify-between text-slate-300 mb-1">
                  ...
                  <span className="font-semibold">{localPrefs.stepFreeOnly || localPrefs.profileId === 'wheelchair' ? '60%' : '35%'}</span>
                </div>
                <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden">
                  <div className="bg-emerald-500 h-full rounded-full transition-all duration-300" style={{ width: localPrefs.stepFreeOnly || localPrefs.profileId === 'wheelchair' ? '60%' : '35%' }}></div>
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between text-slate-300 mb-1">
                  ...
                  <span className="font-semibold">{localPrefs.preferSaferRoute || localPrefs.profileId === 'night_safety' ? '50%' : '25%'}</span>
                </div>
                <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden">
                  <div className="bg-blue-500 h-full rounded-full transition-all duration-300" style={{ width: localPrefs.preferSaferRoute || localPrefs.profileId === 'night_safety' ? '50%' : '25%' }}></div>
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between text-slate-300 mb-1">
                  ...
                  <span className="font-semibold">{localPrefs.avoidStairs || localPrefs.avoidCrowded || localPrefs.maxWalkDistanceMeters <= 300 ? '40%' : '20%'}</span>
                </div>
                <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden">
                  <div className="bg-amber-500 h-full rounded-full transition-all duration-300" style={{ width: localPrefs.avoidStairs || localPrefs.avoidCrowded || localPrefs.maxWalkDistanceMeters <= 300 ? '40%' : '20%' }}></div>
                </div>
              </div>
            </div>
          </div>
